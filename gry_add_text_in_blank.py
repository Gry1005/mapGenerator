...
map4_path = 'E:/Spatial Computing & Informatics Laboratory/CutTextArea/dataset4/backGround_OS/*/'
#map4_path = 'E:/Spatial Computing & Informatics Laboratory/CutTextArea/dataset/concat_out/'
save_path = 'D:/pycharmWorkspace/mapGenerator/synthMap_application/OS_10_80_Grey/'
fonts_path = 'D:/pycharmWorkspace/mapGenerator/synthMap_application/generate_data/fonts/'
GB_path = "D:/pycharmWorkspace/mapGenerator/synthMap_application/generate_data/GB.txt"


# load the words
word_set = set()
geoname_f = open(GB_path, "r",encoding='utf-8')
...
while cnt<1000:
    ...
    #img_bg_pil=img_bg_pil.resize((512,512))
