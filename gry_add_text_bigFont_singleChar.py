...
save_path = 'D:/pycharmWorkspace/mapGenerator/synthMap_application/concat_out_fontsW_IA_bigF_sChar/'

#fonts_path = 'fonts/'
fonts_path = 'D:/pycharmWorkspace/SmallForTextDetection/fontsW_clean/*/'

#text
text_dir='D:/pycharmWorkspace/mapGenerator/synthMap_application/generate_data/IA_placenames/'


text_pathList=glob.glob(text_dir+'*.txt')
...
def zk_addToMap(img_bg, text_layer, p):
    ...
    #text_bi[text_bina <= 200] = 255
    #text_bi[text_bina > 200] = 0
...
for i, patch_path in enumerate(map4_set):
    ...
    while (text_num < text_num_thresh):
        ...
        #!!!
        #print('ind:',ind,'font_face:',font_face)
